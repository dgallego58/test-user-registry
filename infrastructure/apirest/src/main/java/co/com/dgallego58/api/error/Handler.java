...
import co.com.dgallego58.security.filter.jwt.SchematicJwtException;
...
public class Handler {
    ...
    @ExceptionHandler({RegistryAccessUseCaseService.RegistryAccessUseCaseException.class})
    public ResponseEntity<ErrorResponse> handleUseCase(RegistryAccessUseCaseService.RegistryAccessUseCaseException e) {
        log.error("error on {} validation ", e.getMessage(), e);
