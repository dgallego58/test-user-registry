package co.com.dgallego58.api.access;
...
public record UserRegistry(String name, @Email String email,
    ...
    public co.com.dgallego58.domain.access.model.UserRegistry toModel() {
        return new co.com.dgallego58.domain.access.model.UserRegistry(name, email, password, phones);
    }
}
